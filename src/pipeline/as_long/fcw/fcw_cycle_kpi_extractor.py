...
class FcwCycleKpiExtractor(RuleBasedCycleKpiExtractor):
    ...
    SIGNAL_SPECS = {
        ...
        "precond_blocked": {"signal": "fcwPrecondBlkFromNdas", "required": False},
        "throttle": {"signal": "throttleValue", "required": False},
        "steer_angle": {"signal": "steerWheelAngleDeg", "required": False},
        "steer_rate": {"signal": "steerWheelAngleSpeedDeg", "required": False},
        "yaw_rate": {"signal": "yawRateDeg", "required": False},
        "lat_accel": {"signal": "latActAccel", "required": False},
